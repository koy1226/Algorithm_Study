...
vector<int> solution(vector<string> wallpaper) {
    ...
    ux = *std::min_element(lux.begin(), lux.end());
    uy = *std::min_element(luy.begin(), luy.end());
    dx = *std::max_element(rdx.begin(), rdx.end());
    dy = *std::max_element(rdy.begin(), rdy.end());
    
    answer.insert(answer.end(),{ux, uy, dx, dy});
